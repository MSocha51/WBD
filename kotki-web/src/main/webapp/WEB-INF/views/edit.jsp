	...
	<jsp:body>
		...
		<span class="minititle"><strong>Dodaj kota</strong></span>
			...
			<form:form action="/addCat" modelAttribute="catDTO" method="post" id="form">
				...
				<div class=names>
					<span>Imię:</span>
					<form:input path="name" id="name" value="${cat.name}"></form:input>
					<form:errors path="name" cssclass="error" />
				</div>
			<div class=names>
				
					<span>Data urodzenia:</span>
					<form:input path="birthdayDate" id="birthdayDate" type="date" value="${cat.birthdayDate }"></form:input>
					<form:errors path="birthdayDate" cssclass="error" />
				</div>
				<div class=names>
				
					<span>Płeć</span>
	 				<form:input path="sex" id="sex" value="${cat.sex}"></form:input>
					<form:errors path="sex" cssclass="error" />
				</div>
				<div class=names>
				
					<span>Komplet łapek:</span>
	 				<form:input path="paws" id="paws" value="${cat.paws}"></form:input>
					<form:errors path="paws" cssclass="error" />
				</div>
				<div class=names>
				
					<span>Sterylizacja:</span>	
					<form:input path="sterizlization" id="sterizlization" value="${cat.sterizlization}"></form:input>
					<form:errors path="sterizlization" cssclass="error" />
				</div>
				<div class=names>
				
					<span>Wzrok:</span>	
					<form:input path="sight" id="sight" value="${cat.sight}"></form:input>
					<form:errors path="sight" cssclass="error" />
				</div>
				<div class=names>
				
					<span>Rasa:</span>	
					<form:input path="race" id="race" value="${cat.race}"></form:input>
